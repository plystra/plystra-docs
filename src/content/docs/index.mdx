...
Plystra Core documentation uses three maturity labels:
...
<CardGrid>
	<Card title="Quickstart" icon="rocket" href="/getting-started/">
		Start Plystra Core with Docker or Go, apply migrations, bootstrap a demo admin explicitly, and protect an invoice approval action.
	</Card>
...
<CardGrid stagger>
	<Card title="Core runtime" icon="rocket">
		The `plystra/core` repository is the runtime entrypoint. It loads privileged system capabilities at startup and exposes `/api/v1`.
	</Card>
