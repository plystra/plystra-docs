...
Plystra `1.0.0-rc115` keeps the runtime entrypoint and the official system capabilities inside the `plystra/plystra` repository. The kernel loads them as built-in privileged modules during process startup.
...
- semantic version, currently `1.0.0-rc115`
